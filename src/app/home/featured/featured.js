          ...
          <div className="col-xl-12">
            <div className="tp-featured-slider">
                ...
                <SwiperSlide>
                  <div className="tp-featured-item swiper-slide white-bg p-relative z-index-1">
                    <div
                      ...
                      style={{
                        background:
                          "url(assets/img/product/slider/product-slider-1.jpg)",
                      }}
                    ></div>
                    <div className="tp-featured-content">
                      <h3 className="tp-featured-title">
                        <a href="#">
                          Clothing <br /> Collection 2023
                        </a>
                      </h3>
              ...
              <div className="tp-featured-slider-arrow mt-45">
                <button
                  className="tp-featured-slider-button-prev"
                  ref={prevRef}
                >
                  <svg
                    width="33"
                ...
                <button
                  className="tp-featured-slider-button-next"
                  ref={nextRef}
                >
                  <svg
                    width="33"
