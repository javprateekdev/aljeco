                        ...
                        >
                          <SwiperSlide>
                            <div className="tp-testimonial-item text-center mb-20 swiper-slide">
                              ...
                              <div className="tp-testimonial-content">
                                <p>
                                  “ How you use the city or town name is up to
                                  you. All results may be freely used in any
                                  work.”
                                </p>
                              </div>
                          ...
                          <SwiperSlide>
                            <div className="tp-testimonial-item text-center mb-20 swiper-slide">
                              ...
                              <div className="tp-testimonial-content">
                                <p>
                                  “Very happy with our choice to take our
                                  daughter to Brave care. The entire team was
                                  great! Thank you!”
                                </p>
                              </div>
                              <div className="tp-testimonial-user-wrapper d-flex align-items-center justify-content-center">
                          ...
                          <SwiperSlide>
                            <div className="tp-testimonial-item text-center mb-20 swiper-slide">
                              ...
                              <div className="tp-testimonial-content">
                                <p>
                                  “Thanks for all your efforts and teamwork over
                                  the last several months! Thank you so much”
                                </p>
                              </div>
                              <div className="tp-testimonial-user-wrapper d-flex align-items-center justify-content-center">
                                <div className="tp-testimonial-user d-flex align-items-center">
